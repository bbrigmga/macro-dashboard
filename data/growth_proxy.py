"""Build the GDP growth proxy composite for the regime quadrant."""
...
def build_gdp_growth_proxy(
    ticker_data: dict[str, pd.Series],
    pairs: tuple[GrowthProxyPair, ...] = GROWTH_PROXY_PAIRS,
    ...
    composite.name = "gdp_growth_proxy"
